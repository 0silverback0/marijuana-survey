...
class UserForm(FlaskForm):
    ...
    smoker = RadioField('smoke?', choices=[ ('smoker', 'smoker'), ('non-smoker', 'non-smoker')], validators=[DataRequired()])
    ...
    type = RadioField('Type', choices=['Indica', 'Sativa', 'Hybrid'], validators=[DataRequired()])
